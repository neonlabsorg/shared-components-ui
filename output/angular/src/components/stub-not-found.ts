...
@Component({
  ...
  template: `
    <div [class]="customClassList?.container || containerClass || '' + ' div'">
      <div class="div-2">
        <div class="div-3">
          <div
            [class]="customClassList?.heading?.container || headingContainerClass || '' + ' div-4'"
          >
            <h6
              [class]="customClassList?.heading?.subtitle || headingSubtitleClass || '' + ' h6'"
            >
              {{DEFAULTS.heading.subtitle}}
            </h6>

            <h1
              [class]="customClassList?.heading?.title || headingTitleClass || '' + ' h1'"
            >
          ...
          <div class="div-5">
            <div class="div-6">
              <button
                [class]="customClassList?.backButton || backButtonClass || '' + ' button'"
                (click)="
          goBack();
        "
              >
              ...
              <button
                [class]="customClassList?.homeButton || homeButtonClass || '' + ' button-2'"
                (click)="
          goHome();
        "
              >
        ...
        <div class="div-7">
          <div
            [class]="customClassList?.card?.container || cardContainerClass || '' + ' div-8'"
          >
            <div class="div-9">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              [class]="customClassList?.card?.title || cardTitleClass || '' + ' div-10'"
            >
              {{DEFAULTS.cards.documentation.title}}
            </div>

            <div
              [class]="customClassList?.card?.description || cardDescriptionClass || '' + ' div-11'"
            >
          ...
          <div
            [class]="customClassList?.card?.container || cardContainerClass || '' + ' div-12'"
          >
            <div class="div-13">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              [class]="customClassList?.card?.title || cardTitleClass || '' + ' div-14'"
            >
              {{DEFAULTS.cards.blog.title}}
            </div>

            <div
              [class]="customClassList?.card?.description || cardDescriptionClass || '' + ' div-15'"
            >
          ...
          <div
            [class]="customClassList?.card?.container || cardContainerClass || '' + ' div-16'"
          >
            <div class="div-17">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              [class]="customClassList?.card?.title || cardTitleClass || '' + ' div-18'"
            >
              {{DEFAULTS.cards.questions.title}}
            </div>

            <div
              [class]="customClassList?.card?.description || cardDescriptionClass || '' + ' div-19'"
            >
...
export class StubNotFound {
  ...
  @Input() headingSubtitleClass: any;
  @Input() headingTitleClass: any;
  @Input() backButtonClass: any;
  @Input() homeButtonClass: any;
  @Input() cardContainerClass: any;
