      ...
      >
        <div className="div-2">
          <div className="div-3">
            <div
              className={
                props.customClassList?.heading?.container ||
                props.headingContainerClass ||
                "" + " div-4"
              }
            >
              <h6
                className={
                  props.customClassList?.heading?.subtitle ||
                  props.headingSubtitleClass ||
                  "" + " h6"
                }
              >
              ...
              <h1
                className={
                  props.customClassList?.heading?.title ||
                  props.headingTitleClass ||
                  "" + " h1"
                }
              >
            ...
            <div className="div-5">
              <div className="div-6">
                <button
                  className={
                    props.customClassList?.backButton ||
                    props.backButtonClass ||
                    "" + " button"
                  }
                  onClick={(event) => {
                    goBack();
                ...
                <button
                  className={
                    props.customClassList?.homeButton ||
                    props.homeButtonClass ||
                    "" + " button-2"
                  }
                  onClick={(event) => {
                    goHome();
          ...
          <div className="div-7">
            <div
              className={
                props.customClassList?.card?.container ||
            ...
            >
              ...
              <div
                className={
                  props.customClassList?.card?.title ||
                  props.cardTitleClass ||
                  "" + " div-10"
                }
              >
              ...
              <div
                className={
                  props.customClassList?.card?.description ||
                  props.cardDescriptionClass ||
                  "" + " div-11"
                }
              >
